...
const Testimonial = () => {
  return (
    <div className="container my-8 mx-auto md:p-6 bg-white">
        ...
        <div className="grid gap-6 md:grid-cols-3 xl:gap-x-12">
          <div className="mb-6 lg:mb-0">
            <div className="relative block rounded-lg bg-pink-500 text-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
              ...
              <div className="p-6">
                <h5 className="mb-2 text-lg font-bold text-primary">John Doe</h5>
                ...
                <p>
                  Whenever I’ve had questions, the customer support team was quick to respond and incredibly helpful.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-6 lg:mb-0">
            <div className="relative block rounded-lg bg-pink-500 text-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
              ...
              <div className="p-6">
                <h5 className="mb-2 text-lg font-bold text-primary">Halley Frank</h5>
                <ul className="mb-6 flex justify-center">
                  <li>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <p>
                  I love how intuitive and easy-to-navigate the platform is. Booking facilities and managing schedules have never been this straightforward!
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mb-0">
            <div className="relative block rounded-lg bg-pink-500 text-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
              ...
              <div className="p-6">
                <h5 className="mb-2 text-lg font-bold text-primary">Lisa Trey</h5>
                <ul className="mb-6 flex justify-center">
                  <li>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <p>
                  The platform offers everything I need in one place, from booking to managing payments. It’s a game-changer for facility management!
                </p>
              </div>
            </div>
          </div>
